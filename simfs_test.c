...
void test_read_write_inode(void){
    ...
    CTEST_ASSERT(test_read_node->size == 1, "Testing succefull reading and previous writing of size");
    CTEST_ASSERT(test_read_node->owner_id == 2, "Testing succefull reading and previous writing of owner_id");
    CTEST_ASSERT(test_read_node->permissions == 3, "Testing succefull reading and previous writing of permissions");
    CTEST_ASSERT(test_read_node->flags == 4, "Testing succefull reading and previous writing of flags");
    CTEST_ASSERT(test_read_node->link_count == 5, "Testing succefull reading and previous writing of link_count");
